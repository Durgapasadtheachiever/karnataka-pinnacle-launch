  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-luxury focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Luxury variants for Karnataka Properties
        hero: "bg-gradient-gold text-accent-foreground font-semibold shadow-gold hover:shadow-luxury hover:scale-105",
        premium: "bg-primary text-primary-foreground border border-accent-gold hover:bg-gradient-gold hover:text-accent-foreground shadow-card",
        luxury: "bg-transparent border-2 border-accent-gold text-accent-gold hover:bg-accent-gold hover:text-accent-foreground font-medium",
        elegant: "bg-gradient-primary text-primary-foreground shadow-luxury hover:shadow-gold hover:scale-105",
      },
      size: {
